...
(10, 'B005', 'Meja', '3', 'Furniture', 'Buah', 140, '640000', '89600000');
...
INSERT INTO `brg_keluar` (`id`, `id_transaksi`, `tanggal`, `nama_barang`, `kategori`, `customer`, `jumlah`, `satuan`) VALUES
(0, 'T001', '2022-06-14', 'Buku Tulis', 'Alat Tulis', 'PT. Makmur', 40, 'Lusin');
...
INSERT INTO `brg_masuk` (`id`, `id_transaksi`, `tanggal`, `nama_barang`, `kategori`, `supplier`, `jumlah`, `satuan`) VALUES
(0, 'M001', '2022-06-14', 'Mesin Cuci', 'Elektronik', 'PT. Sejahtera', 50, 'Buah');
...
CREATE TABLE `kategori` (
  ...
  `avarage_harga` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
