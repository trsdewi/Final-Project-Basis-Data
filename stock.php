...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update barang set nama_barang='$nama_barang', kode_barang='$kode_barang', jenis='$jenis', id_supplier='$id_supplier', satuan='$satuan', stock='$stock' where id='$id'");
			...
			<?php 
				...
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama']. "</u> <u>".($p['id_supplier'])."</u> &nbsp <u>".$p['jenis']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Barang <?php echo $p['kode_barang']?> - <?php echo $p['jenis']?> - <?php 
                                                            ...
                                                            <input type="text" id="kode_barang" name="kode_barang" class="form-control" value="<?php echo $p['kode_baramg'] ?>">

                                                            <label for="nama_barang">Nama_barang</label>
                                                            <input type="text" id="nama_barang" name="nama_barang" class="form-control" value="<?php echo $p['nama_barang'] ?>">

                                                            <label for="id_supplier">Id_supplier</label>
                                                            <input type="text" id="id_supplier" name="id_supplier" class="form-control" value="<?php echo $p['id_supplier'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Barang <?php echo $p['kode_barang']?> - <?php echo $p['nama_barang']?> - <?php echo $p['jenis']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									...
									<input name="id_supplier" type="text" class="form-control" placeholder="id_supplier Barang">
								</div>
								<div class="form-group">
									<label>jenis</label>
